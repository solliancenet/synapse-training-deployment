...
function CreateCredFile($azureUsername, $azurePassword, $azureTenantID, $azureSubscriptionID, $deploymentId)
{
  ...
  $WebClient.DownloadFile("https://github.com/solliancenet/synapse-training-deployment/blob/master/artifacts/environment-setup/spektra/AzureCreds.txt","C:\LabFiles\AzureCreds.txt")
  $WebClient.DownloadFile("https://github.com/solliancenet/synapse-training-deployment/blob/master/artifacts/environment-setup/spektra/AzureCreds.ps1","C:\LabFiles\AzureCreds.ps1")
...
$url = "https://github.com/solliancenet/synapse-training-deployment/blob/master/artifacts/environment-setup/spektra/deploy.parameters.post.json"
...
New-AzResourceGroupDeployment -ResourceGroupName $resourceGroupName -TemplateUri "https://github.com/solliancenet/synapse-training-deployment/blob/master/artifacts/environment-setup/automation/00-asa-workspace-core.json" -TemplateParameterFile "c:\LabFiles\parameters.json"
...
git clone https://github.com/solliancenet/synapse-training-deployment.git synapse-ws-L400
